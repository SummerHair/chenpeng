    ...
    <div class="title">
      ...
      <div class="title-select">
        <el-row>
          ...
          <el-col :span="8">
            <span>视频分类</span>
            <el-select v-model="form.classification" placeholder="请选择视频分类" clearable>
              <el-option
...
<script>
  import {articlelist,encyclopedialistall,addeiitarticle} from "../../request/api";
  export default {
        name: "index",
        data(){
            return {
